...
// ============ Look Left: 左右眼不对称！============
// 左眼 (变大，向左偏移适中)
constexpr EyeConfig Preset_LookLeft_Left = {.offset_x = -17,   // 向左偏移适中
                                            .offset_y = 0,
                                            .height = 90,      // 比Normal大约20%
                                            .width = 72,       // 比Normal大约20%
                                            .slope_top = 0,
                                            .slope_bottom = 0,
                                            .radius_top = 12,  // 与Normal一致
                                            .radius_bottom = 12,
                                            .inverse_radius_top = 0,
                                            .inverse_radius_bottom = 0,
                                            .inverse_offset_top = 0,
...
// 右眼 (正常大小，向左偏移更多，形成眼距变小+跟随效果)
constexpr EyeConfig Preset_LookLeft_Right = {.offset_x = -35,  // 向左偏移更多！
                                             .offset_y = 0,
                                             .height = 75,     // Normal大小
                                             .width = 60,      // Normal大小
                                             .slope_top = 0,
...
// ============ Look Right: 左右眼不对称！============
// 左眼 (正常大小，向右偏移更多，形成眼距变小+跟随效果)
constexpr EyeConfig Preset_LookRight_Left = {.offset_x = 35,   // 向右偏移更多！
                                             .offset_y = 0,
                                             .height = 75,     // Normal大小
                                             .width = 60,      // Normal大小
                                             .slope_top = 0,
...
// 右眼 (变大，向右偏移适中)
constexpr EyeConfig Preset_LookRight_Right = {.offset_x = 17,   // 向右偏移适中
                                              .offset_y = 0,
                                              .height = 90,     // 比Normal大约20%
                                              .width = 72,      // 比Normal大约20%
                                              .slope_top = 0,
...
// ============ Look Up: 对称表情 ============
// 两眼向上偏移，大小与Normal相同
constexpr EyeConfig Preset_LookUp = {.offset_x = 0,
                                     .offset_y = -35,  // 向上偏移更多（负值表示向上）
                                     .height = 75,     // 与Normal相同
                                     .width = 60,      // 与Normal相同
                                     .slope_top = 0,
                                     .slope_bottom = 0,
...
// ============ Look Down: 对称表情 ============
// 两眼向下偏移，大小与Normal相同
constexpr EyeConfig Preset_LookDown = {.offset_x = 0,
                                       .offset_y = 35,   // 向下偏移更多（正值表示向下）
                                       .height = 75,     // 与Normal相同
                                       .width = 60,      // 与Normal相同
                                       .slope_top = 0,
                                       .slope_bottom = 0,
...
inline const EyeConfig &GetPreset(Emotion emotion) {
  ...
  case Emotion::Awe:
    return Preset_Awe;
  case Emotion::LookLeft:
    return Preset_LookLeft_Right; // 右眼预设
  case Emotion::LookRight:
    return Preset_LookRight_Right; // 右眼预设（变大）
  case Emotion::LookUp:
    return Preset_LookUp; // 对称表情
  case Emotion::LookDown:
    return Preset_LookDown; // 对称表情
  default:
    return Preset_Normal;
  }
}
...
inline const EyeConfig &GetPresetLeft(Emotion emotion) {
  ...
  case Emotion::LookLeft:
    return Preset_LookLeft_Left; // 左眼变大
  case Emotion::LookRight:
    return Preset_LookRight_Left; // 左眼正常大小
  default:
...
inline bool IsAsymmetricEmotion(Emotion emotion) {
  return emotion == Emotion::Skeptic || emotion == Emotion::Furious ||
         emotion == Emotion::LookLeft || emotion == Emotion::LookRight;
}
