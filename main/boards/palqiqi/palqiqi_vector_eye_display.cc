...
void PalqiqiVectorEyeDisplay::CheckRandomEmotion() {
  ...
  if (now - last_emotion_change_ > next_emotion_interval_) {
    ...
    static const vector_eyes::Emotion idle_emotions[] = {
        ...
        vector_eyes::Emotion::Normal,     // (共3次，约20%)
        vector_eyes::Emotion::Sleepy,     // 约7%
        vector_eyes::Emotion::Skeptic,    // 约7%
        // 方向看表情 - 增加权重 (共8次，约53%)
        vector_eyes::Emotion::LookLeft,
        vector_eyes::Emotion::LookLeft,
        vector_eyes::Emotion::LookRight,
        vector_eyes::Emotion::LookRight,
        vector_eyes::Emotion::LookUp,
        vector_eyes::Emotion::LookUp,
        vector_eyes::Emotion::LookDown,
        vector_eyes::Emotion::LookDown,
    };
